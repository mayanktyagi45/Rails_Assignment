class TrainingPlansController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @training_plan.save
        format.html { redirect_to training_plan_url(@training_plan), notice: "Training plan was successfully created." }
  ...
  def update
    respond_to do |format|
      if @training_plan.update(training_plan_params)
        format.html { redirect_to training_plan_url(@training_plan), notice: "Training plan was successfully updated." }
  ...
  private
    ...
    def training_plan_params
      params.require(:training_plan).permit(:category, :description, :duration)
    end
end
